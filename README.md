...
![Spotify Logo](https://github.com/Vinit-joshi2/Blinkit-DashBoard/blob/main/Blinkit%20logo.jpeg)
...
- 💰 **Total Sales**: The dashboard reveals a cumulative sales value of **$1.20M**, indicating a strong revenue performance across all outlets and items.
  
- 📦 **Number of Items Sold**: A total of **8,523 items** were recorded, Seem like  significant product movement and customer engagement.
  
- 💵 **Average Sales per Item**: With an **average sales value of $141**, the dataset shows a balanced price distribution across different item categories and outlets.
  
- ⭐ **Average Customer Rating**: The overall **average rating of 3.9** suggests a generally positive customer experience


### 🏬 Sales by Outlet Size

- 🟨 **Medium-sized outlets** generated the highest total sales, contributing approximately **$507.9K**, making them the most revenue-efficient outlet size.

- 🟦 **Small-sized outlets** followed with **$444.79K** in total sales, showing strong performance despite limited space.

- 🟥 **High-sized outlets** contributed the least with **$248.99K**, suggesting that larger store formats may not always translate into higher sales.
